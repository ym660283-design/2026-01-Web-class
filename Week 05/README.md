...
- Java 기본 변수와 문자열 배열 실습 프로그램 작성
- Scanner 입력 기반 2부터 9까지 배수 출력 프로그램 작성
- 2000 이하 완전수와 그 약수 출력 프로그램 작성
- JSP 기본 구조와 선언문/스크립틀릿/표현식 학습

## 추가 파일

- `JavaBasic.java` : Java 기본 변수와 문자열 배열을 선언하고 출력하는 예제.
- `MultiplesScanner.java` : Scanner로 입력한 숫자보다 작은 2부터 9까지의 배수를 출력하는 예제.
- `PerfectNumbers.java` : 2000 이하 완전수를 찾고 모든 약수를 출력하는 예제.
